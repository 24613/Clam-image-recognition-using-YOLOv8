...
- CUDA版本需在11.8以上，可至NVIDIA官網依電腦作業系統選定下載CUDA的版本進行下載。https://developer.nvidia.com/cuda-downloads
...
- 下載lableimg進行物件標記：
  ...
  - 進入頁面：<br>
    ...
    - 3.設定標籤資訊存取的路徑(與圖片資料夾一樣為dataset)。
  ...
  - 回資料夾查看是否成功存取標籤資料，標籤資料名稱應與圖片名稱相同：<br>
